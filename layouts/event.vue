        ...
        >
          ...
          >
            ...
            <template v-else>
              ...
              <div v-if="page?.fields.dateBegin" class="text-muted-text text-xs mt-2">
                <span>Beginn: </span>
                <span>{{ page?.fields.dateBegin }}</span>
              </div>
              <div v-if="page?.fields.dateEnd" class="text-muted-text text-xs mt-2">
                <span>Ende: </span>
                <span>{{ page?.fields.dateEnd }}</span>
              </div>              
