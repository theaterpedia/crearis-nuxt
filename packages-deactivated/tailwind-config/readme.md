...
The intention is to replay Tailwind3-style color-naming/utilities (aka 'bg-lime-200' + 'dark:bg-lime-700') by simplified and themable color-naming/utilities based on the shadcn/ui-logic (bg-muted, bg-primary, bg-accent, bg-destructive ...) that takes dark as a second palette