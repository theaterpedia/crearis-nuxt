...
export default {
  theme: {
    ...
    colors: {
      'background': 'var(--color-bg) / <alpha-value>)',
      'foreground': 'var(--color-contrast) / <alpha-value>)',
      'card': 'var(--color-card-bg) / <alpha-value>)',
      'card-contrast': 'var(--color-card-contrast) / <alpha-value>)',
      'popover': 'var(--color-popover-bg) / <alpha-value>)',
      ...
      'muted': 'var(--color-muted-bg) / <alpha-value>)',
      'muted-contrast': 'var(--color-muted-contrast) / <alpha-value>)',
      'accent': 'var(--color-accent-bg) / <alpha-value>)',
      'accent-contrast': 'var(--color-accent-contrast) / <alpha-value>)',
      'focus': 'var(--focus-bg) / <alpha-value>)',
