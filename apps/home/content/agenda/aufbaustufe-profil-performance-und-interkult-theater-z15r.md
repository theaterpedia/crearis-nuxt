...
ctype: course
tag: course
description: Aufbaustufe Theaterpädagogik (BuT) - Profil Performance & Interkulturelles Theater SEP 2026 – AUG 2028
...
# Profile modules: R1-R2, RA, H1-H3, F1-F3, K2-K6
# ─────────────────────────────────────────────────────────────────────────
#
details:
  programm:
    ...
    info:
      struktur: |
        ...
        - **Profil R1–R2** Theorie, Site Specific Performance
        - **Physisches Theater H1–H3** Terminologie, Inszenieren, Aufführen
        - **Dokumentarisches Theater F1–F3** Recherche bis Aufführung
        - **Hauptkolloquium K2–K6** begleitend
      ...
      verlauf: |
        ...
        - Profilteam: Rosalin Hertrich, Eleanora Allerdings, Hans Dönitz
  konditionen:
...
consulting:
  ...
  categories:
    ...
    - key: schedules
      ...
      teaser: "2 Jahre in 3 Phasen: Vertiefung (SEP 26 – FEB 27), Profil Performance (MÄR 27 – DEZ 27), Abschluss (JAN 28 – AUG 28). Du kannst auch nur die Vertiefung buchen und später entscheiden. Profilwechsel bis Ende OKT 2026 problemlos, bis FEB 2027 im Notfall. Nachholung verpasster Seminare bis JUN 2029 möglich."
      options:
...
items:
  ...
  r1_profil_intro:
    ctype: event
    shortcode: R1
    title: "Zeitgenössische Theaterpädagogik **Performance & Interkult. Theater**"
    tag: Profil Performance · MÄR 2027 – AUG 2028
    image:
  ...
  h_physisches_theater:
    ctype: event
    shortcode: H1
    title: "Sprechen mit dem Körper **Physisches Theater**"
    tag: H1–H3 · Eleanora Allerdings
    image:
  ...
  r2_site_specific:
    ctype: event
    shortcode: R2
    title: "Verkörperung, Diversität, Habitus **Profilkolloquium**"
    tag: R1–R2 + RA · Rosalin Hertrich
    image:
  ...
  f_doku_theater:
    ctype: event
    shortcode: F1
    title: "Recherche, Interviews, Material **Dokumentarisches Theater**"
    tag: F1–F3 · Szenische Dokumentation
    image:
