...
pageBottom:
  ...
  consulting:
    ...
    description: "Quereinstieg, Förderung, Termine — wähle deine Themen."
    domainCode: "dasei2"
    ...
    categories:
      ...
      - key: terms_and_options
        ...
        label: Finanzierung
        teaser: "Frühbucher bis 9. April: 6 Raten = € 1.320 (Ersparnis € 440). Normalpreis: 8 Raten = € 1.760 — mit KOMPASS-Förderung für Solo-Selbständige bis zu 90% Übernahme möglich (ca. € 176 Eigenanteil). Storno bis 10 Tage nach C1 ohne Zusatzkosten."
        options:
      ...
      - key: continuation
        ...
        label: Nach Modul C
        teaser: "Nach Abschluss: Modul D (Szenisches Projekt), Einstieg in die Aufbaustufe, oder Vervollständigung der Grundlagenbildung durch Nachholung von A+B."
        options:
