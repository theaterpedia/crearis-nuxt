...
hero:
  ...
  content_width: full
  cta:
    title: Info-Teaser (Do. 19.6 18:00 online)
    link: details?src=/agenda/info-teaser-aa_1583
image:
  alt: Katz und Maus
...
>> 
>>> [!button-tmp|variant=primary to=ausbildung-theaterpaedagogik/kurs_einstiege_ins_theaterspiel]
>>> los geht's
...
>> 
>>> [!button-tmp|variant=primary to=ausbildung-theaterpaedagogik/kurs_grundlagenbildung]
...
>> 
>>> [!button-tmp|variant=link size=small to=/ausbildung-theaterpaedagogik/aufbaustufe/profil_theatrales_lernen]
>>> Profil Theatrales Lernen -->
>>
>>> [!button-tmp|variant=link size=small to=/ausbildung-theaterpaedagogik/aufbaustufe/profil_performance]
