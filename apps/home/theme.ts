...
export const colorVars = {
  ...
  'primary-contrast': 'oklch(from var(--color-gray-base) calc(l + 1 * (0 - l)) calc(c / 4.5) h)',
  'secondary-contrast': 'oklch(from var(--color-gray-base) calc(l + 1 * (0 - l)) calc(c / 4.5) h)',
