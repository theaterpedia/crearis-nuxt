<template>
  <div
    ...
    :id="anchor"
    class="anchor-line"
    :class="[`anchor-line--${variant}`, { 'anchor-line--inline': inline, 'anchor-line--sticky': sticky }]"
  ></div>
</template>
...
const props = defineProps({
  ...
  /**
   * When true, the anchor line sticks to the top of the viewport when scrolled.
   * @default false
   */
  sticky: {
    type: Boolean,
