...
const sections = [
  {
    ...
    subsections: [
      {
        label: 'account.accountSettings.section.personalData',
        link: '/my-account/personal-data',
      },
      {
        label: 'account.accountSettings.section.billingDetails',
        link: '/my-account/billing-details',
      },
      {
        label: 'account.accountSettings.section.shippingDetails',
        link: '/my-account/shipping-details',
      },
    ],
  },
  {
    title: 'account.myOrders.heading',
    icon: SfIconShoppingCart,
    subsections: [
      {
        label: 'account.myOrders.section.myOrders',
...
const breadcrumbs = computed(() => [
  { name: 'home', link: '/' },
  { name: 'account.heading', link: '/my-account' },
