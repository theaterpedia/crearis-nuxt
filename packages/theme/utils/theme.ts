export default {
  ...
  colors: {
    ...
    'card-base': 'oklch(var(--color-card-base) / <alpha-value>)',
    'card-contrast': 'oklch(var(--color-card-contrast) / <alpha-value>)',
    'popover-base': 'oklch(var(--color-popover-base) / <alpha-value>)',
    'popover-contrast': 'oklch(var(--color-popover-contrast) / <alpha-value>)',
    'primary-base': 'oklch(var(--color-primary-base) / <alpha-value>)',
    'primary-contrast': 'oklch(var(--color-primary-contrast) / <alpha-value>)',
    'secondary-base': 'oklch(var(--color-secondary-base) / <alpha-value>)',
    'secondary-contrast': 'oklch(var(--color-secondary-contrast) / <alpha-value>)',
    'muted-base': 'oklch(var(--color-muted-base) / <alpha-value>)',
    'muted-contrast': 'oklch(var(--color-muted-contrast) / <alpha-value>)',
    'accent-base': 'oklch(var(--color-accent-base) / <alpha-value>)',
    'accent-contrast': 'oklch(var(--color-accent-contrast) / <alpha-value>)',
    'focus-base': 'oklch(var(--focus-base) / <alpha-value>)',
    'focus-contrast': 'oklch(var(--focus-contrast) / <alpha-value>)',
    'negative-base': 'oklch(var(--color-negative-base) / <alpha-value>)',
    'negative-contrast': 'oklch(var(--color-negative-contrast) / <alpha-value>)',
