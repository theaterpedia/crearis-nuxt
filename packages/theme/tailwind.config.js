...
export default {
  ...
  theme: {
    ...
    colors: {
      ...
      'card-base': 'hsl(var(--color-card-base) / <alpha-value>)',
      'card-foreground': 'hsl(var(--color-card-contrast) / <alpha-value>)',
      'popover-base': 'hsl(var(--color-popover-base) / <alpha-value>)',
      ...
      'secondary-base': 'hsl(var(--color-secondary-base) / <alpha-value>)',
      'secondary-foreground': 'hsl(var(--color-secondary-contrast) / <alpha-value>)',
      'muted-base': 'hsl(var(--color-muted-base) / <alpha-value>)',
      'muted-foreground': 'hsl(var(--color-muted-contrast) / <alpha-value>)',
      'accent-base': 'hsl(var(--color-accent-base) / <alpha-value>)',
      ...
      'destructive-base': 'hsl(var(--color-destructive-base) / <alpha-value>)',
