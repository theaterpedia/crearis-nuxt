...
import { ref, computed, reactive, watch, resolveComponent } from 'vue'
...
const colorVars = computed({
  get() {
    return getVars(baseColors, colormap.value, true, getInverted())
  },
  set() {
    return getVars(baseColors, colormap.value, true, getInverted())
  },
...
const loadTheme = (id) => {
  showTheme(id)
  colorVars.value = getVars(baseColors, colormap.value, true, getInverted())
}
