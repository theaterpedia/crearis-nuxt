...
<template>
  <div :class="props.padding ? '' : 'pl-2 md:pl-4 lg:pl-6 xl:pl-8 ' + 'logoClass font-semibold dark:bg-black'">
    <h2
      ...
      :class="
        props.logoSize === 'default'
          ...
          : props.logoSize === 'sm'
            ? 'invisible font-mona text-sm lg:visible lg:tracking-tight xl:text-lg'
            : 'font-mona text-xs tracking-wider sm:text-base lg:text-2xl 2xl:text-4xl 2xl:tracking-tight'
      "
    >
      <slot>
    ...
    >
      ...
      <span :class="filled && !extended ? 'text-secondary-400' : 'text-secondary-700'">pedia</span>
    </h1>
  </div>
</template>
