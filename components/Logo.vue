    ...
    >
      <Prose>
        ...
        >
          ...
          <span
            v-show="extended"
            class="line-solid subline"
            style="margin-left: 0.4em; margin-top: -0.5em; color: var(--color-primary-bg)"
          >
            Theaterpädagogik
          </span>
          <span v-show="extended" class="line-dashed subline" style="color: var(--color-accent-contrast)">suchen und finden</span>
        </h1>
      </Prose>
    </div>
    <Component
...
.line-solid {
  text-decoration: overline 2px var(--color-primary-bg);
}

.line-dashed {
  text-decoration: overline dashed 2px var(--color-primary-bg);
}
